...
syn keyword pentadactylCommand loadplugins lpl gr[oup] ! run Clistk[eys] Clk
    ...
    \ PlugInstall ab[breviate] addo[ns] ao au[tocmd] ba[ck] background bg
    \ bd[elete] blistk[eys] blk bm[ap] bma[rk] bmarks bno[remap] b[uffer]
    \ buffers files ls tabs bunm[ap] ca[bbreviate] caretlistk[eys] caretlk
    \ caretm[ap] caretno[remap] caretunm[ap] cd chd[ir] clistk[eys] clk cm[ap]
    \ cno[remap] colo[rscheme] com[mand] comp[letions] contexts cookies ck
    ...
    \ extt[oggle] extu[pdate] feedkeys fk feh fini[sh] fo[rward] fw frameo[nly]
    \ ha[rdcopy] h[elp],halp helpa[ll] hi[ghlight] hist[ory] hs ia[bbreviate] if
    ...
    \ mkv[imruntime] mlistk[eys] mlk mm[ap] mno[remap] mpv munm[ap] nlistk[eys]
    \ nlk nm[ap] nno[remap] noh[lfind] no[remap] norm[al] nunm[ap] olistk[eys]
    \ olk om[ap] ono[remap] o[pen] ounm[ap] pa[geinfo] pagest[yle] pas pin[tab]
    \ pref[erences] prefs pr[ivate] pr0n porn pw[d] qma[rk] qmarks q[uit]
    \ quita[ll] qa[ll] qute redr[aw] reg[isters] reh[ash] re[load] reloada[ll]
    ...
    \ ve[rsion] vie[wsource] vlistk[eys] vlk vm[ap] vno[remap] vunm[ap] wbag
