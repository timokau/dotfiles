...
(after! org
  ...
  (setq org-agenda-custom-commands
      ...
      ("g" "Grouped view"
       ...
       ((tags-todo "research_experiment")
        (tags-todo "research_reading")
        (tags-todo "research_writing")
        (tags-todo "consideration")
        (tags-todo "work_admin")
        (tags-todo "work_process")
        (tags-todo "life")
        ; All tasks not included in any of the previous groups
        (tags-todo "-research_experiment-research_reading-research_writing-consideration-work_admin-work_process-life")
        ))
